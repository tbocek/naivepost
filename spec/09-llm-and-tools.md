...
- Anything else (a 4xx/5xx, an unusable answer): one retry after 2 s, first failure only. A status code is never "the server went away". New: a 5xx whose body names a device or memory failure backs off like a transport death, not resent at once.
